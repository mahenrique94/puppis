	...
	<nav class="band-nav-lube" role="complementary">
		<div class="row" role="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
				<label><a href="<c:url value="/dashboard/comercio"/>"><fmt:message key="nav.comercio"/></a>&nbsp;<i class="icon-right-open"></i>&nbsp;<a href="<c:url value="/dashboard/relatorios/comercio"/>"><fmt:message key="nav.comercio.relatorios"/></a>&nbsp;<i class="icon-right-open"></i>&nbsp;<fmt:message key="nav.comercio.relatorios.movimentacao.produto"/></label>					
			</div>
		</div>
	</nav>
				...
				<section class="block-body block-body-padding">
					...
					<div class="row" role="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
							...
							<select class="form-data validate" data-class="sl" id="slProduto-Servico_Movimento_Tipo_json_01" name="parametrosWeb[3].parametroInicial"></select>
						</div>
					</div>
					<div class="row" role="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
			...
			<fieldset class="block-lube">
				...
				<section class="block-body block-body-padding">
					...
					<div class="row" role="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
							<label><fmt:message key="label.movimento.tipo"/></label>
							<select class="form-data validate" data-class="sl" id="slProduto-Servico_Movimento_Tipo_json_01" name="parametrosWeb[3].parametroFinal"></select>
						</div>
					</div>
					<div class="row" role="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
