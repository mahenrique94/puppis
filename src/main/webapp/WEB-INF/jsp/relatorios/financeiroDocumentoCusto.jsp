...
<form action="<c:url value="/relatorio/processar"/>" class="o-form" id="formrelatoriodocumentocusto" method="post" name="formrelatoriodocumentocusto" target="_blank">
	<input name="parametrosWeb[0].parametroInicial" type="hidden" value="IRFINDOCCUSTO">
					...
					<section class="c-block__body c-block__body--padding">
						<div class="l-row" role="row">
							<div class="u-grid--12" role="grid">
								<label class="o-form__text" for="centrocustoinicial"><fmt:message key="label.id.centro.custo"/></label>
								<div class="o-form__group">
									<input class="o-form__data has-validation" data-search="centrocustoinicial" data-target="cadcentrocusto.id" id="centrocustoinicial" min="0" name="parametrosWeb[2].parametroInicial" pattern="number0to9" step="1" type="number">
									<span class="o-form__groupElement"><a class="o-button--lube" href="<c:url value="/cadastro/centro-de-custo/listarsl?search=centrocustoinicial"/>" onclick="ModalController.show(this, event);" role="link" title="<fmt:message key="button.pesquisar"/>"><i class="icon-search"></i></a></span>
								</div>
							</div>
						</div>
						<div class="l-row" role="row">
			...
			<div class="u-grid--6" role="grid">
				<fieldset class="c-block--lube">
					...
					<section class="c-block__body c-block__body--padding">
						<div class="l-row" role="row">
							<div class="u-grid--12" role="grid">
								<label class="o-form__text" for="centrocustofinal"><fmt:message key="label.id.centro.custo"/></label>
								<div class="o-form__group">
									<input class="o-form__data has-validation" data-search="centrocustofinal" data-target="cadcentrocusto.id" id="centrocustofinal" min="0" name="parametrosWeb[2].parametroFinal" pattern="number0to9" step="1" type="number">
									<span class="o-form__groupElement"><a class="o-button--lube" href="<c:url value="/cadastro/centro-de-custo/listarsl?search=centrocustofinal"/>" onclick="ModalController.show(this, event);" role="link" title="<fmt:message key="button.pesquisar"/>"><i class="icon-search"></i></a></span>
								</div>
							</div>
						</div>
						<div class="l-row" role="row">
