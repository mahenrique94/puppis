...
<form action="<c:url value="/relatorio/processar"/>" class="o-form" id="formrelatoriodocumentopessoa" method="post" name="formrelatoriodocumentopessoa" target="_blank">
	<input name="parametrosWeb[0].parametroInicial" type="hidden" value="IRFINDOCPESSOA">
	...
	<nav class="o-navbar--gary" role="complementary">
		<div class="o-breadcrumb--arrow">
			...
			<span class="o-breadcrumb__link"><a class="is-inactive" href="<c:url value="/relatorios/financeiro/documento/pessoa"/>" role="link" title="<fmt:message key="nav.financeiro.relatorios.documento.pessoa"/>"><fmt:message key="nav.financeiro.relatorios.documento.pessoa"/></a></span>
		</div>
	</nav>
					...
					<section class="c-block__body c-block__body--padding">
						<div class="l-row" role="row">
							<div class="u-grid--12" role="grid">
								<label class="o-form__text" for="definicaoinicial"><fmt:message key="label.id.definicao"/></label>
								<div class="o-form__group">
									<input class="o-form__data has-validation" data-search="definicaoinicial" data-target="pesdefinicao.id" id="definicaoinicial" min="0" name="parametrosWeb[2].parametroInicial" pattern="number0to9" step="1" type="number">
									<span class="o-form__groupElement"><a class="o-button--lube" href="<c:url value="/pessoa/definicao/listarsl?search=definicaoinicial"/>" onclick="ModalController.show(this, event);" role="link" title="<fmt:message key="button.pesquisar"/>"><i class="icon-search"></i></a></span>
								</div>
							</div>
						</div>
						<div class="l-row" role="row">
			...
			<div class="u-grid--6" role="grid">
				<fieldset class="c-block--lube">
					...
					<section class="c-block__body c-block__body--padding">
						<div class="l-row" role="row">
							<div class="u-grid--12" role="grid">
								<label class="o-form__text" for="definicaofinal"><fmt:message key="label.id.definicao"/></label>
								<div class="o-form__group">
									<input class="o-form__data has-validation" data-search="definicaofinal" data-target="pesdefinicao.id" id="definicaofinal" min="0" name="parametrosWeb[2].parametroFinal" pattern="number0to9" step="1" type="number">
									<span class="o-form__groupElement"><a class="o-button--lube" href="<c:url value="/pessoa/definicao/listarsl?search=definicaofinal"/>" onclick="ModalController.show(this, event);" role="link" title="<fmt:message key="button.pesquisar"/>"><i class="icon-search"></i></a></span>
								</div>
							</div>
						</div>
						<div class="l-row" role="row">
