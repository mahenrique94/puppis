...
<form action="<c:url value="/relatorio/processar"/>" class="o-form" id="formrelatoriocentrocusto" method="post" name="formrelatoriocentrocusto" target="_blank">
	<input aria-hidden="true" name="parametrosWeb[0].parametroInicial" type="hidden" value="IRCENTROCUSTO">
	...
	<nav class="o-navbar--gary" role="complementary">
		<div class="o-breadcrumb--arrow">
			...
			<span class="o-breadcrumb__link"><a class="is-inactive" href="<c:url value="/relatorio/centro/custo"/>" role="link" title="<fmt:message key="nav.cadastro.relatorios.centro.custo"/>"><fmt:message key="nav.cadastro.relatorios.centro.custo"/></a></span>
		</div>
	</nav>
					...
					<section class="c-block__body c-block__body--padding">
						<div class="l-row" role="row">
							<div class="u-grid--12" role="grid">
								...
								<input class="o-form__data has-validation" id="datacadastroinicial" maxlength="10" name="parametrosWeb[2].parametroInicial" onkeypress="checkMask(event);" onkeyup="mask(maskData, this, event);" pattern="data" placeholder="<fmt:message key="placeholder.data"/>" type="text">
							</div>
						</div>
					</section>
				</fieldset>
					...
					<section class="c-block__body c-block__body--padding">
						<div class="l-row" role="row">
							<div class="u-grid--12" role="grid">
								...
								<input class="o-form__data has-validation" id="datacadastrofinal" maxlength="10" name="parametrosWeb[2].parametroFinal" onkeypress="checkMask(event);" onkeyup="mask(maskData, this, event);" pattern="data" placeholder="<fmt:message key="placeholder.data"/>" type="text">
							</div>
						</div>
					</section>
				</fieldset>
