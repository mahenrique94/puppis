...
<fieldset class="block-lube">
	<legend class="block-header">
		<h1 class="block-title"><label><fmt:message key="nav.cadastro"/>&nbsp;<fmt:message key="label.barra"/>&nbsp;<fmt:message key="nav.cadastro.nivel.formacao"/></label></h1>
	</legend>
	<form action="<c:url value="/nivel-de-formacao"/>" class="form-search" id="formlistarsysnivelformacao" method="get" name="formlistarsysnivelformacao" role="search">
	...
	<section class="block-body no-padding">
		<display:table class="table-default" export="false" id="obj" name="${SysNivelFormacaoList}" requestURI="/nivel-de-formacao">
