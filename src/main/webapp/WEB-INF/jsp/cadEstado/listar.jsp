...
<fieldset class="block-lube">
	...
	<form action="<c:url value="/estado"/>" class="form-search" id="formlistarcadestado" method="get" name="formlistarcadestado" role="search">
	...
	<section class="block-body no-padding">
		<display:table class="table-default" export="false" id="obj" name="${CadEstadoList}" requestURI="/estado">
