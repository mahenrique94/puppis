...
<form action="<c:url value="/administrador/usuario/tipo-de-acesso/modulo"/>" class="form-modern" data-controler="ModalController" id="formadmtipoacessomodulo" method="post" name="formadmtipoacessomodulo" onsubmit="return enviarPost(this);" role="form">
	<input name="obj.id" type="hidden" value="${obj.id}">
	<input name="obj.idmodulo.idaux" type="hidden" value="${obj.idmodulo.id}">
	<input name="obj.idtipoacesso.id" type="hidden" value="${obj.idtipoacesso.id}">
