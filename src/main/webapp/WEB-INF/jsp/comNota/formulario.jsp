		...
		<section aria-expanded="true" aria-hidden="false" class="clearfix" role="form">
			<div class="row" role="row">
				<div class="col-xs-12-last col-sm-12-last col-md-12-last col-lg-12-last" role="separator">
					...
					<select class="select-form" data-class="slSysTipoOperacao" id="slSystem_Tipo-de-operacao_json_1" name="obj.idtipooperacao.id" ${readOnly}></select>
			...
			<c:if test="${obj.id != null && obj.idtipooperacao.id == 1}">
				...
				<div class="row" role="row">
					...
					<div class="col-xs-8-last col-sm-8-last col-md-8-last col-lg-8-last" role="separator">
