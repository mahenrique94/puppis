...
<ul aria-haspopup="true" class="tab-responsive-default">
	...
	<li aria-controls="content-tab2" aria-labelledby="tab2" aria-selected="false" role="tab"><a href="#content-tab2" id="tab2" role="presentation"><i class="font-7x icon-box"></i>&nbsp;<fmt:message key="tab.item"/></a></li>
	<li aria-controls="content-tab3" aria-labelledby="tab3" aria-selected="false" role="tab"><a href="#content-tab3" id="tab3" role="presentation"><i class="font-7x icon-dollar"></i>&nbsp;<fmt:message key="tab.valor"/></a></li>
</ul>
