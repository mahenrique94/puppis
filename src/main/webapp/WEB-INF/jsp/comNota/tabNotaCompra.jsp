...
<section aria-expanded="true" aria-hidden="false" class="form-body" role="form">
	...
	<div class="row" role="row">
		...
		<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" role="separator">
			...
			<input class="form-data validate" maxlength="10" name="obj.dataemissao" onkeypress="format(this, event, maskData);" pattern="data" type="text" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${obj.dataemissao.time}" type="date"/>">
	...
	<div class="row" role="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
			...
			<select class="form-data ss validate" data-class="slPesDefinicao" data-fields="idtipo.descricao" data-parameters="FORNECEDOR" id="slPessoa_Definicao_Json_01" required name="obj.iddefinicao.id"></select>
			<netsis:validationMessage name="obj.operacao"/>
		</div>
	</div>
	<div class="row" role="row">
