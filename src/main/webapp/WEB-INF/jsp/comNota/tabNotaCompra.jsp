...
<section class="o-form__body o-form__body--padding">
	...
	<div class="l-row" role="row">
		...
		<div class="u-grid--3" role="grid">
			...
			<input ${autoFocus} class="o-form__data has-validation" id="dataemissao" max="31-12-2900" maxlength="10" min="01-01-1900" name="obj.dataemissao" onkeypress="checkMask(event);" onkeyup="mask(maskData, this, event);" pattern="data" ${readOnly} type="text" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${obj.dataemissao.time}" type="date"/>">
		</div>
		<div class="u-grid--3" role="grid">
	...
	<div class="l-row" role="row">
		<div class="u-grid--6" role="grid">
			<label class="o-form__text" for="numeronota"><fmt:message key="label.numero.nota"/><validate:validationMessage name="obj.numero"/></label>
			<input class="o-form__data has-validation" id="numeronota" min="0" name="obj.numero" pattern="number0to9" ${readOnly} step="1" type="number" value="${obj.numero}">
		</div>
		<div class="u-grid--6" role="grid">
			<label class="o-form__text" for="serienote"><fmt:message key="label.serie.nota"/><validate:validationMessage name="obj.serie"/></label>
			<input class="o-form__data has-validation full" id="serienote" min="0" name="obj.serie" pattern="number0to9" ${readOnly} step="1" type="number" value="${obj.serie}">
		</div>
	</div>
</section>