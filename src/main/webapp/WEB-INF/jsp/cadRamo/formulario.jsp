...
<fieldset class="block-lube">
	...
	<form action="<c:url value="/ramo"/>" class="form-inline" id="formlistarcadramo" method="post" name="formlistarcadramo" role="form">
		...
		<nav class="clearfix nav-block" role="navigation">
			<div class="w-100">
				...
				<a href="<c:url value="/ramo"/>" class="btn-md float-left m-right-5" title="<fmt:message key="button.pesquisar"/>"><span class="icon-search"></span>&nbsp;<fmt:message key="button.pesquisar"/></a>
			</div>
		</nav>
