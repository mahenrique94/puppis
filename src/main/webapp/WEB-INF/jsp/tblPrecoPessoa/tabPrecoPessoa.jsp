...
<section class="o-form__body o-form__body--padding">
	<div class="l-row" role="row">
		<div class="u-grid-" role="grid">
			...
			<select aria-required="true" ${autoFocus} class="o-form__data has-validation ss-search" data-select="slPesDefinicao" data-url="slPessoa_Definicao_Json" id="pessoa" name="obj.iddefinicao.id" required></select>
		</div>
	</div>
</section>