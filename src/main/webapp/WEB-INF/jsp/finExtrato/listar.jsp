		...
		<form action="<c:url value="/financeiro/extrato"/>" class="form-search" id="formlistarfinextrato" method="get" name="formlistarfinextrato" role="search">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-2 col-lg-1">
					<a href="<c:url value="/financeiro/extrato/formulario"/>" class="btn-md float-left" title="<fmt:message key="button.novo"/>"><span class="icon-plus"></span>&nbsp;<fmt:message key="button.novo"/></a>
				</div>
