...
<form action="<c:url value="/administrador/usuario/grupo"/>" class="o-form" id="formadmgrupo" method="post" name="formadmgrupo" role="form">
	...
	<nav class="o-navbar--gary" role="complementary">
		<div class="o-breadcrumb--arrow">
			...
			<span class="o-breadcrumb__link"><a href="<c:url value="/administrador/usuario/grupo"/>" role="link" title="<fmt:message key="nav.administrador.usuario.grupo"/>"><fmt:message key="nav.administrador.usuario.grupo"/></a></span>
			<span class="o-breadcrumb__link"><a href="<c:url value="/administrador/usuario/grupo"/>" role="link" title="<fmt:message key="nav.lista"/>"><fmt:message key="nav.lista"/></a></span>
			<span class="o-breadcrumb__link"><a class="is-inactive" href="<c:url value="/administrador/usuario/grupo/formulario"/>" role="link" title="<fmt:message key="nav.formulario"/>"><fmt:message key="nav.formulario"/></a></span>
		</div>
	</nav>
	...
	<menu class="o-toolbar--lube is-fixedBottomFull" role="menubar">
		...
		<menuitem class="o-toolbar__item" role="menuitem"><a href="<c:url value="/administrador/usuario/grupo"/>" role="link" title="<fmt:message key="button.pesquisar"/>"><i class="icon-search"></i>&nbsp;<fmt:message key="button.pesquisar"/></a></menuitem>
	</menu> 
</form>
