		...
		<form action="<c:url value="/administrador/grupo"/>" class="form-search" id="formlistaradmgrupo" method="get" name="formlistaradmgrupo" role="search">
			<div class="row">
				...
				<div class="col-xs-12-last col-sm-12-last col-md-2 col-lg-1">
					<a href="<c:url value="/administrador/grupo/formulario"/>" class="btn-md float-left" title="<fmt:message key="button.novo"/>"><span class="icon-plus"></span>&nbsp;<fmt:message key="button.novo"/></a>
				</div>
