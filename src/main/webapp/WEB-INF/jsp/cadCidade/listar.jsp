...
<form action="<c:url value="/cadastro/cidade"/>" class="form-modern" id="formlistarcadcidade" method="get" name="formlistarcadcidade" role="search">
	<nav class="band-nav-lube" role="complementary">
		<div class="row" role="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
				<label><a href="<c:url value="/dashboard/cadastro"/>"><fmt:message key="nav.cadastro"/></a>&nbsp;<i class="icon-right-open"></i>&nbsp;<fmt:message key="nav.cadastro.cidade"/></label>					
			</div>
		</div>
		<div class="row" role="row">
...
<display:table class="table-default" export="false" id="obj" name="${CadCidadeList}" requestURI="/cadastro/cidade">
	...
	<display:column headerScope="idestado.uf" property="idestado.uf" style="text-align: center;width: 50px;" titleKey="displaytag.uf"/>
</display:table>
