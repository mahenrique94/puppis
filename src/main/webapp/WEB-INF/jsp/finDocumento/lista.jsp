...
<display:table class="table-default table-disabled" export="false" id="obj" name="${FinDocumentoList}" requestURI="/financeiro/documento">
	...
	<c:if test="${param.idTipoOperacao.equals('4')}"> <!-- 4 = BAIXA -->
		<display:column style="text-align: center;width: 330px;">
			<input autocomplete="off" class="form-data" disabled name="obj[${obj_rowNum}].valortotal" pattern="numeric10_2" placeholder="Valor" style="margin-top: 0;width: 100px;" type="text">
			<input autocomplete="off" class="form-data" disabled name="obj[${obj_rowNum}].valordesconto" pattern="numeric10_2" placeholder="Descontos" style="margin-top: 0;width: 100px;" type="text">
			<input autocomplete="off" class="form-data" disabled name="obj[${obj_rowNum}].valorjuros" pattern="numeric10_2" placeholder="Juros" style="margin-top: 0;width: 100px;" type="text">
		</display:column>
	</c:if>
