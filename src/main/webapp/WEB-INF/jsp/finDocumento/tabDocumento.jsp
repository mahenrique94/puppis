...
<section aria-expanded="true" aria-hidden="false" class="form-body" role="form">
	...
	<div class="row" role="row">
		...
		<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" role="separator">
			...
			<input class="form-data validate" data-mask="data" maxlength="10" min="01-01-1970" name="obj.dataemissao" pattern="data" required type="text" value="<fmt:formatDate pattern="dd/MM/yyyy" type="date" value="${obj.dataemissao.time}"/>">
			<netsis:validationMessage name="obj.dataemissao"/>
		</div>
		<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" role="separator">
			<label><fmt:message key="label.data.vencimento"/></label>
			<input class="form-data validate" name="obj.datavencimento" required type="text" value="<fmt:formatDate pattern="dd/MM/yyyy" type="date" value="${obj.datavencimento.time}"/>">
