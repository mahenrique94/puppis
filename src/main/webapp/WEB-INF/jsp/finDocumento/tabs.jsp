...
<div class="tab-group m-bottom-10">
	<div aria-expanded="false" aria-hidden="true" aria-labelledby="tab1" class="no-padding" id="content-tab1" role="tabpanel">
		<nav class="nav-band">
			<button class="btn-xs" formaction="<c:url value="/financeiro/documento/calcular"/>" title="<fmt:message key="button.calcular"/>" type="submit"><span class="icon-usd"></span>&nbsp;<fmt:message key="button.calcular"/></button>
		</nav>
	...
	<div aria-expanded="false" aria-hidden="true" aria-labelledby="tab2" class="no-padding" id="content-tab2" role="tabpanel">
		<nav class="nav-band">
			<a class="btn-xs" data-toggle="modal" href="<c:url value="/financeiro/documento/centro-de-custo/formulario/${obj.id}"/>" title="<fmt:message key="button.novo"/>"><span class="icon-plus"></span>&nbsp;<fmt:message key="button.novo"/></a>
		</nav>
