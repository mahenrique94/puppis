			...
			<div class="clearfix container-center">
				<nav class="nav-square" role="navigation">
					<ul class="nav-row" role="menubar">
						<li role="menuitem"><a href="<c:url value="/financeiro/banco"/>"><i class="font-5x icon-bank"></i><fmt:message key="nav.financeiro.banco"/></a></li>
						...
						<li role="menuitem"><a href="<c:url value="/financeiro/conta-bancaria"/>"><i class="font-5x icon-cube"></i><fmt:message key="nav.financeiro.conta.bancaria"/></a></li>
						<li role="menuitem"><a href="<c:url value="/cadastro/estado"/>"><i class="font-5x icon-road"></i><fmt:message key="nav.cadastro.estado"/></a></li>
						<li role="menuitem"><a href="<c:url value="/financeiro/forma-de-pagamento"/>"><i class="font-5x icon-money"></i><fmt:message key="nav.financeiro.forma.pagamento"/></a></li>
						<li role="menuitem"><a href="<c:url value="/financeiro/historico"/>"><i class="font-5x icon-comment-empty"></i><fmt:message key="nav.financeiro.historico"/></a></li>
					</ul>
					<ul class="nav-row" role="menubar">
