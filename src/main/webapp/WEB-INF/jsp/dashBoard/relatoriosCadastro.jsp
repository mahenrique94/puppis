	...
	<div class="o-dashboard__content">
		<nav class="c-square--gary" role="navigation">
			<menu aria-haspopup="true" class="c-square__menu" role="menubar">
				...
				<menuitem class="c-square__item ${disabledCadastro}" role="menuitem"><a href="<c:url value="/relatorio/produto/classe"/>" role="link" title="<fmt:message key="nav.cadastro.relatorios.produto.classe"/>"><i class="icon-cube"></i><fmt:message key="nav.cadastro.relatorios.produto.servico.classe"/></a></menuitem>
				<menuitem class="c-square__item ${disabledCadastro}" role="menuitem"><a href="<c:url value="/relatorio/produto/grupo"/>" role="link" title="<fmt:message key="nav.cadastro.relatorios.produto.grupo"/>"><i class="icon-cubes"></i><fmt:message key="nav.cadastro.relatorios.produto.servico.grupo"/></a></menuitem>
