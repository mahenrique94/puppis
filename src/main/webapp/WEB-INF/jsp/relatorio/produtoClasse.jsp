	...
	<nav class="band-nav-lube" role="complementary">
		<div class="row" role="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
				<label><a href="<c:url value="/dashboard/cadastro"/>"><fmt:message key="nav.cadastro"/></a>&nbsp;<i class="icon-right-open"></i>&nbsp;<a href="<c:url value="/dashboard/relatorios/cadastro"/>"><fmt:message key="nav.cadastro.relatorios"/></a>&nbsp;<i class="icon-right-open"></i>&nbsp;<fmt:message key="nav.cadastro.relatorios.centro.custo"/></label>					
			</div>
		</div>
	</nav>
					...
					<div class="row" role="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
							...
							<div class="form-data-group">
								<input autocomplete="off" class="form-data validate" id="classeinicial_id" min="0" name="parametrosWeb[2].parametroInicial" step="1" type="number">
								<span class="form-data-group-btn"><a class="btn-default" href="<c:url value="/produto-servico/classe/listarsl?search=classeinicial"/>" onclick="ModalController.show(this, event);"><i class="icon-search"></i></a></span>
							</div>
						</div>
					</div>
					<div class="row" role="row">
				...
				<section class="block-body block-body-padding">
					<div class="row" role="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" role="separator">
							<label><fmt:message key="label.id"/></label>
							<div class="form-data-group">
								<input autocomplete="off" class="form-data validate" id="classefinal_id" min="0" name="parametrosWeb[2].parametroFinal" step="1" type="number">
								<span class="form-data-group-btn"><a class="btn-default" href="<c:url value="/produto-servico/classe/listarsl?search=classefinal"/>" onclick="ModalController.show(this, event);"><i class="icon-search"></i></a></span>
							</div>
						</div>
					</div>
					<div class="row" role="row">
