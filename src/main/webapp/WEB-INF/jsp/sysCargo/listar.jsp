...
<fieldset class="block-lube">
	<legend class="block-header">
		<h1 class="block-title"><label><fmt:message key="nav.cadastro"/>&nbsp;<fmt:message key="label.barra"/>&nbsp;<fmt:message key="nav.cadastro.cargo"/></label></h1>
	</legend>
	<form action="<c:url value="/cargo"/>" class="form-search" id="formlistarsyscargo" method="get" name="formlistarsyscargo" role="search">
	...
	<section class="block-body no-padding">
		<display:table class="table-default" export="false" id="obj" name="${SysCargoList}" requestURI="/cargo">
