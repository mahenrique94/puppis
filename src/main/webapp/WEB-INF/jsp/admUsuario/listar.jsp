...
<form action="<c:url value="/administrador/usuario"/>" class="form-modern" id="formlistaradmusuario" method="get" name="formlistaradmusuario" role="search">
...
<nav class="nav-group-tie nav-fixed-bottom" role="complementary">
	<ul>
		<li><a href="<c:url value="/administrador/usuario/formulario"/>"><i class="icon-plus"></i>&nbsp;<fmt:message key="button.novo"/></a></li>
	</ul>
</nav>
