...
<fieldset class="block-lube">
	...
	<form action="<c:url value="/administrador/usuario"/>" class="form-search" id="formlistaradmusuario" method="get" name="formlistaradmusuario" role="search">
		<nav class="clearfix nav-block" role="navigation">
			<div class="w-25"><a href="<c:url value="/administrador/usuario/formulario"/>" class="btn-md float-left m-right-5" title="<fmt:message key="button.novo"/>"><span class="icon-plus"></span>&nbsp;<fmt:message key="button.novo"/></a></div>
