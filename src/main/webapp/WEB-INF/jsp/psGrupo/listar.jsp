...
<display:table class="table-default" export="false" id="obj" name="${PsGrupoList}" requestURI="/produto-servico/grupo">
	...
	<display:column style="width: 150px;text-align: center;">
		...
		<button class="btn-der btn-xs" formaction="<c:url value="/produto-servico/grupo?obj.id=${obj.id}"/>" onclick="deletar(this);" type="button"><span class="icon-trash"></span>&nbsp;<fmt:message key="button.deletar"/></button>
	</display:column>
</display:table>
