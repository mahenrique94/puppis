	...
	<section aria-expanded="true" aria-hidden="false" class="form-body" role="form">
		...
		<div class="row" role="row">
			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" role="separator">
				...
				<input class="form-data validate" maxlength="13" name="obj.porcjuros" pattern="numeric10_2" type="text" value="<fmt:formatNumber pattern="0.00" type="currency" value="${obj.porcjuros}"/>">
