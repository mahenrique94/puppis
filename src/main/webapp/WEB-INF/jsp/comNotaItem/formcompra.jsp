	...
	<section class="o-form__body o-form__body--padding o-modal__body">
		...
		<div class="l-row" role="row">
			...
			<div class="u-grid--6" role="separator">
				...
				<input aria-required="true" class="o-form__data has-validation" id="valorunitario" maxlength="13" name="obj.valorunitario" pattern="numeric10-2" ${readOnly} required type="text" value="<fmt:formatNumber pattern="0.00" type="currency" value="${obj.valorunitario}"/>">
			</div>
		</div>
		<div class="l-row" role="row">
			<div class="u-grid--3" role="separator">
				<label class="o-form__text" for="porcicms"><fmt:message key="label.porc.icms"/><validate:validationMessage name="obj.porcicms"/></label>
				<input class="o-form__data has-validation" id="porcicms" maxlength="13" name="obj.porcicms" pattern="numeric10-2" ${readOnly} type="text" value="<fmt:formatNumber pattern="0.00" type="currency" value="${obj.porcicms}"/>">
			</div>
			<div class="u-grid--3" role="separator">
				<label class="o-form__text" for="porcipi"><fmt:message key="label.porc.ipi"/><validate:validationMessage name="obj.porcipi"/></label>
				<input class="o-form__data has-validation" id="porcipi" maxlength="13" name="obj.porcipi" pattern="numeric10-2" ${readOnly} type="text" value="<fmt:formatNumber pattern="0.00" type="currency" value="${obj.porcipi}"/>">
			</div>
			<div class="u-grid--3" role="separator">
				<label class="o-form__text" for="porcjuros"><fmt:message key="label.porc.juros"/><validate:validationMessage name="obj.porcjuros"/></label>
				<input class="o-form__data has-validation" id="porcjuros" maxlength="13" name="obj.porcjuros" pattern="numeric10-2" ${readOnly} type="text" value="<fmt:formatNumber pattern="0.00" type="currency" value="${obj.porcjuros}"/>">
			</div>
			<div class="u-grid--3" role="separator">
