	...
	<section aria-expanded="true" aria-hidden="false" class="form-body" role="form">
		...
		<div class="row" role="row">
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" role="separator">
				...
				<input class="form-data validate" maxlength="10" name="obj.quantidade" pattern="numeric10_2" ${readOnly} required type="text" value="<fmt:formatNumber pattern="0.00" type="currency" value="${obj.quantidade}"/>">
		...
		<div class="row" role="row">
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" role="separator">
				...
				<input class="form-data validate" maxlength="13" name="obj.porcicms" pattern="numeric10_2" ${readOnly} type="text" value="<fmt:formatNumber pattern="0.00" type="currency" value="${obj.porcicms}"/>">
				<netsis:validationMessage name="obj.porcicms"/>
			</div>
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" role="separator">
				<label><fmt:message key="label.porc.ipi"/></label>
				<input class="form-data validate" maxlength="13" name="obj.porcipi" pattern="numeric10_2" ${readOnly} type="text" value="<fmt:formatNumber pattern="0.00" type="currency" value="${obj.porcipi}"/>">
				<netsis:validationMessage name="obj.porcipi"/>
			</div>
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" role="separator">
				<label><fmt:message key="label.porc.juros"/></label>
				<input class="form-data validate" maxlength="13" name="obj.porcjuros" pattern="numeric10_2" ${readOnly} type="text" value="<fmt:formatNumber pattern="0.00" type="currency" value="${obj.porcjuros}"/>">
				<netsis:validationMessage name="obj.porcjuros"/>
			</div>
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" role="separator">
