...
<div class="container-tie">
	<div class="container-header">
		<form action="<c:url value="/administrador/tipo-de-acesso"/>" class="form-search" id="formlistaradmtipoacesso" method="get" name="formlistaradmtipoacesso" role="search">
			<div class="row">
	...
	<display:table class="table-default" export="false" id="obj" name="${AdmTipoAcessoList}" requestURI="/administrador/tipo-de-acesso">
		...
		<display:column style="width: 150px;text-align: center;">
			<a class="btn-xs" href="<c:url value="/administrador/tipo-de-acesso/${obj.id}"/>"><span class="icon-pencil"></span>&nbsp;<fmt:message key="button.editar"/></a>
			<a class="btn-xs" href="<c:url value="/administrador/tipo-de-acesso/${obj.id}"/>" onclick="deletar(this);"><span class="icon-trash"></span>&nbsp;<fmt:message key="button.deletar"/></a>
		</display:column>
	</display:table>
</div>
