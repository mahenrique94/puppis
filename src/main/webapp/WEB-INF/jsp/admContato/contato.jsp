...
<div class="row" role="row">
	...
	<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5" role="separator">
		...
		<input class="form-data validate" maxlength="9" name="obj.contato.telefone" onkeypress="format(this, event, telefone);" pattern="telefone" type="text" value="${obj.contato.telefone}">
		<netsis:validationMessage name="obj.contato.telefone"/>
	</div>
	<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5" role="separator">
		<label class="align-left"><fmt:message key="label.celular"/></label>
		<input class="form-data validate" maxlength="11" name="obj.contato.celular" onkeypress="format(this, event, celular);" pattern="celular" type="text" value="${obj.contato.celular}">
