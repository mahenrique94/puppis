		...
		<form action="<c:url value="/financeiro/controle"/>" class="form-search" id="formlistarfincontrole" method="get" name="formlistarfincontrole" role="search">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-2 col-lg-1">
					<a class="btn-md float-left" href="<c:url value="/financeiro/controle/formulario"/>" title="<fmt:message key="button.novo"/>"><span class="icon-plus"></span>&nbsp;<fmt:message key="button.novo"/></a>
				</div>
