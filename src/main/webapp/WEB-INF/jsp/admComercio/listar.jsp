		...
		<form action="<c:url value="/administrador/comercio"/>" class="form-search" id="formlistaradmcomercio" method="get" name="formlistaradmcomercio" role="search">
			<div class="row">
				...
				<div class="col-xs-12-last col-sm-12-last col-md-2 col-lg-1">
					<a href="<c:url value="/administrador/comercio/formulario"/>" class="btn-md float-left" title="<fmt:message key="button.novo"/>"><span class="icon-plus"></span>&nbsp;<fmt:message key="button.novo"/></a>
				</div>
