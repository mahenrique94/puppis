...
<form action="<c:url value="/administrador/comercio"/>" class="form-modern" id="formlistaradmcomercio" method="get" name="formlistaradmcomercio" role="search">
...
<nav class="nav-group-tie nav-fixed-bottom" role="complementary">
	<ul>
		<li><a href="<c:url value="/administrador/comercio/formulario"/>"><i class="icon-plus"></i>&nbsp;<fmt:message key="button.novo"/></a></li>
	</ul>
</nav>
