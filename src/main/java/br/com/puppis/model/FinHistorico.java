...
public class FinHistorico implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "fin_historico", sequenceName = "sqfin_historico", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "fin_historico")
	private Integer id;
	@NotNull
	@NotEmpty
