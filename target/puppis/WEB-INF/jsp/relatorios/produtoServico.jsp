...
<form action="<c:url value="/relatorio/processar"/>" class="o-form" id="formrelatorioprodutoservico" method="post" name="formrelatorioprodutoservico" target="_blank">
	<input name="parametrosWeb[0].parametroInicial" type="hidden" value="IRPRODUTO">
	...
	<nav class="o-navbar--gary" role="complementary">
		<div class="o-breadcrumb--arrow">
			...
			<span class="o-breadcrumb__link"><a class="is-inactive" href="<c:url value="/relatorios/produto/servico"/>" role="link" title="<fmt:message key="nav.cadastro.relatorios.produto.servico"/>"><fmt:message key="nav.cadastro.relatorios.produto.servico"/></a></span>
		</div>
	</nav>
						...
						<div class="l-row" role="row">
							<div class="u-grid--12" role="grid">
								...
								<div class="o-form__group">
									<input class="o-form__data has-validation" data-search="produtoservicoinicial" data-target="psprodutoservico.id" id="idinicial" min="0" name="parametrosWeb[2].parametroInicial" pattern="number0to9" step="1" type="number">
					...
					<section class="c-block__body c-block__body--padding">
						<div class="l-row" role="row">
							<div class="u-grid--12" role="grid">
								...
								<div class="o-form__group">
									<input class="o-form__data has-validation" data-search="produtoservicofinal" data-target="psprodutoservico.id" id="idfinal" min="0" name="parametrosWeb[2].parametroFinal" pattern="number0to9" step="1" type="number">
